...
import { Backdrop, Button, Card, CardContent, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Divider, Slide, } from '@mui/material';
    ...
    return (
        <>
            <Dialog
                ...
                PaperProps={{
                    style: {
                        backgroundColor: darkMode ? "   rgb(40, 51, 74)" : 'white',
                        boxShadow: "none"
                    },
                }}
            >
                
                <DialogTitle id="alert-dialog-title" sx={{...{color:'#ffff', backgroundColor:'rgb(40, 51, 74)' }, ...props?.esError ? {borderBottom: 'solid 4px red'} : {}}}>
